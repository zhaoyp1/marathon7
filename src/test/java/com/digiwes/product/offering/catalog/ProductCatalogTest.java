...
public class ProductCatalogTest extends TestCase {
    ...
    public void testPublish() throws Exception {
        ...
        BusinessCode errorCode =  catalog.publish(null,validFor);
        assertEquals("publish a offering but it's null ,compare to return errorCode.", BusinessCode.PROD_OFFERING_IS_NULL.getCode(),errorCode.getCode());
        ...
        assertEquals("publish a offering ,compare to return errorCode.", BusinessCode.SUCCESS.getCode(), errorCode.getCode());
        ...
        assertEquals("publish a different offering but the validFor is same,compare to return errorCode.", BusinessCode.SUCCESS.getCode(), errorCode.getCode());
        ...
        assertEquals("publish a exists offering but the validFor is different,compare to return errorCode.", BusinessCode.SUCCESS.getCode(), errorCode.getCode());
        ...
        assertEquals("publish a exists offering ,compare to return errorCode.", BusinessCode.PROD_OFFERING_CATALOG_OFFERING_HAS_BEEN_PUBLISHED.getCode(), errorCode.getCode());
        ...
        assertEquals("publish a exists offering but the validFor within the exists offering's publish time,compare to return errorCode.", BusinessCode.PROD_OFFERING_CATALOG_OFFERING_HAS_BEEN_PUBLISHED.getCode(), errorCode.getCode());
        ...
        assertEquals("publish a exists offering but the validFor include the exists offering's publish time,compare to return errorCode.", BusinessCode.PROD_OFFERING_CATALOG_OFFERING_HAS_BEEN_PUBLISHED.getCode(), errorCode.getCode());
        ...
        assertEquals("publish a exists offering but the validFor's endTime include the exists offering's publish time,compare to return errorCode.", BusinessCode.PROD_OFFERING_CATALOG_OFFERING_HAS_BEEN_PUBLISHED.getCode(), errorCode.getCode());
        ...
        assertEquals("publish a exists offering but the validFor's startTime include the exists offering's publish time,compare to return errorCode.", BusinessCode.PROD_OFFERING_CATALOG_OFFERING_HAS_BEEN_PUBLISHED.getCode(), errorCode.getCode());
        ...
        assertEquals("publish a invalid offering ,compare to return errorCode.", BusinessCode.PROD_OFFERING_PUBLISHED_VALIDPERIOD_NOT_IN_OFFERING_VALIDPERIOD.getCode(), errorCode.getCode());
        ...
        assertEquals("publish a offering but the release time is greater than offering's endDateTime,compare to return errorCode.", BusinessCode.PROD_OFFERING_PUBLISHED_VALIDPERIOD_NOT_IN_OFFERING_VALIDPERIOD.getCode(), errorCode.getCode());
        ...
        assertEquals("publish a offering but the release time is greater than offering's validFor,compare to return errorCode.", BusinessCode.PROD_OFFERING_PUBLISHED_VALIDPERIOD_NOT_IN_OFFERING_VALIDPERIOD.getCode(), errorCode.getCode());
    ...
    public void testRetired() throws Exception {
        ...
        BusinessCode errorCode = catalog.retired(null);
        assertEquals("retired a offering but it's null,compare to return errorCode.", BusinessCode.PROD_OFFERING_IS_NULL.getCode(), errorCode.getCode());
        ...
        assertEquals("retired a offering but it's not belong to the catalog,compare to return errorCode.", BusinessCode.PROD_OFFERING_CATALOG_OFFERING_NOT_BE_PUBLISHED.getCode(), errorCode.getCode());
        ...
        assertEquals("retired a offering ,compare to return errorCode.", BusinessCode.SUCCESS.getCode(), errorCode.getCode());
    ...
    public void testRetired1() throws Exception {
        ...
        BusinessCode errorCode = catalog.retired(null,validFor1);
        assertEquals("retired a offering but it's null,compare to return errorCode.", BusinessCode.PROD_OFFERING_IS_NULL.getCode(), errorCode.getCode());
        assertEquals("retired a offering but it's null,expectProdCatalogProdOffer compare to catalog's prodCatalogProdOffer.", expectProdCatalogProdOffer, catalog.getProdCatalogProdOffer());
        ...
        assertEquals("retired a offering but it's not belong to the catalog in the time,compare to return errorCode.", BusinessCode.PROD_OFFERING_CATALOG_OFFERING_NOT_BE_PUBLISHED.getCode(), errorCode.getCode());
